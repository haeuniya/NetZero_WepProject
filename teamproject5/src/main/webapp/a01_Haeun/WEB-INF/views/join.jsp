...
<div class="main">
	...
	<div class="wrap">
		...
		<h3>회원가입 약관동의 및 본인인증단계입니다.</h3>
	   	...
	   	<div class="check03">
	   		<label for="agree03">E-mail 및 SMS 광고성 정보 수신동의 (선택)</label>
			<input id="agree03" name="agree03" type="checkbox">
		</div>
		
		<div class="btn_wrap">
	  		<button type="button" value="next??" id="nextBtn" onclick="goNextPage()"/>
		</div>
</div>
	...
	function goNextPage(){
		...
		const is_checked01 = agree01.checked;
		const is_checked02 = agree02.checked;
		
		if(is_checked01 && is_checked02){
			console.log("체크확인");
